...
func genRawMemClobber(nimSymbol: NimNode, len: int, memIndirect: MemIndirectAccess): seq[NimNode] =
  ...
  let baseType = nimSymbol.getTypeImpl()[2].getTypeImpl()
...
func setToCarryFlag*(a: var Assembler_arm64, carry: NimNode) =
